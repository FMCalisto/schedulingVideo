...
/**
 * This sample demonstrates how to schedule an video that causes a service to
 * be started. This is useful when you want to schedule videos that initiate
...
public class MainActivity extends Activity {
    ...
    // Menu options to set and cancel the video.
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            // When the user clicks START ALARM, set the video.
            case R.id.start_action:
                video.setVideo(this);
                return true;
            // When the user clicks CANCEL ALARM, cancel the video. 
            case R.id.cancel_action:
                video.cancelVideo(this);
                return true;
        }
        return false;
    }
